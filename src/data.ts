...
export const quests = [
  {
    title: 'Iron Week',
    description: 'Complete 3 resistance workouts this week.',
    progress: 2,
    target: 3,
    reward: '+300 XP',
  },
  {
    title: 'Five-Ton Trial',
    description: 'Accumulate 10,000 lb of lifting volume.',
    progress: 7420,
    target: 10000,
    reward: 'Iron Initiate',
  },
  {
    title: 'The Long Road',
    description: 'Cover 15 running miles.',
    progress: 6.8,
    target: 15,
    reward: '+250 Stamina XP',
  },
];
