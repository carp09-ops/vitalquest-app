...
import { heroArtForArchetype,worldArtForArchetype } from './artAssets';
...
export default function TodayV3(){
  ...
  return <SafeAreaView style={styles.safe}><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.page,wide&&styles.pageWide]}><View style={styles.shell}>
    ...
    <Entrance delay={30}><ImageBackground source={{uri:worldArtForArchetype(archetype)}} resizeMode="cover" imageStyle={styles.stageImage} style={[styles.stage,{borderColor:material.edgeStrong}]}>
      <ImageBackground source={{uri:heroArtForArchetype(archetype)}} resizeMode="cover" style={[styles.character,wide&&styles.characterWide]} imageStyle={styles.characterImage}>
...
const styles=StyleSheet.create({
  ...
  brandRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:12,paddingHorizontal:2},wordmark:{fontSize:24,fontWeight:'900',letterSpacing:-1,color:'#F7F8FA'},brandLine:{fontSize:6.5,fontWeight:'900',letterSpacing:1.7,color:'rgba(247,248,250,.48)',marginTop:2},realmPill:{borderWidth:1,borderRadius:999,paddingHorizontal:12,paddingVertical:8},realmPillText:{fontSize:7,fontWeight:'900',letterSpacing:1.1},
  stage:{minHeight:690,borderWidth:1,borderRadius:32,overflow:'hidden',padding:18,justifyContent:'space-between',position:'relative'},stageImage:{borderRadius:31},stageVeil:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(1,4,8,.30)'},stageGlow:{position:'absolute',left:-100,top:-120,width:390,height:390,borderRadius:195,opacity:.42},
  character:{position:'absolute',right:-68,top:54,bottom:130,width:'72%',opacity:.98},characterWide:{right:-38,top:0,bottom:70,width:'51%'},characterImage:{borderRadius:0},characterFade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(1,4,8,.08)'},
  stageHeader:{zIndex:3,gap:18},stageHeaderWide:{flexDirection:'row',justifyContent:'space-between',alignItems:'flex-start'},identity:{maxWidth:610},kicker:{fontSize:7.5,fontWeight:'900',letterSpacing:1.45},heroTitle:{fontFamily:serif,fontSize:50,lineHeight:53,fontWeight:'700',color:'#FFF9EE',marginTop:7,letterSpacing:-1.5},heroTitleCompact:{fontSize:40,lineHeight:44},heroSub:{fontSize:12,lineHeight:19,color:'rgba(247,248,250,.80)',maxWidth:510,marginTop:8},formSeal:{alignSelf:'flex-start',borderWidth:1,borderRadius:15,paddingHorizontal:14,paddingVertical:11,marginTop:16},formTitle:{fontFamily:serif,fontSize:17,fontWeight:'700',color:'#FFF9EE'},formMeta:{fontSize:6.7,fontWeight:'900',letterSpacing:1,marginTop:3},
  levelCrest:{zIndex:4,width:142,height:142,borderWidth:1.5,borderRadius:71,alignItems:'center',justifyContent:'center',padding:17,alignSelf:'flex-end'},levelLabel:{fontSize:6.5,fontWeight:'900',letterSpacing:1.2,color:'rgba(247,248,250,.54)'},levelValue:{fontFamily:serif,fontSize:43,lineHeight:46,fontWeight:'700',color:'#FFF9EE'},levelPct:{fontSize:7.5,fontWeight:'900',letterSpacing:.4},levelTrack:{width:'100%',height:4,borderRadius:99,backgroundColor:'rgba(255,255,255,.12)',overflow:'hidden',marginTop:7},levelFill:{height:'100%',borderRadius:99},
  hud:{zIndex:4,flexDirection:'row',flexWrap:'wrap',gap:7,marginTop:210},hudWide:{marginTop:245,maxWidth:710},hudStat:{minWidth:112,flexGrow:1,flexBasis:112,borderTopWidth:1,borderTopColor:'rgba(255,255,255,.18)',paddingTop:8,paddingRight:8},hudLabel:{fontSize:6.2,fontWeight:'900',letterSpacing:1,color:'rgba(247,248,250,.48)'},hudValue:{fontSize:14,fontWeight:'900',color:'#F7F8FA',marginTop:4},
  questDock:{zIndex:5,borderWidth:1,borderRadius:24,overflow:'hidden',position:'relative',marginTop:14},questAccent:{position:'absolute',left:0,top:0,bottom:0,width:3},questLayout:{padding:16,gap:16},questLayoutWide:{flexDirection:'row',alignItems:'flex-end'},questCopy:{flex:1},questTitle:{fontFamily:serif,fontSize:33,lineHeight:36,fontWeight:'700',color:'#FFF9EE',marginTop:5},questSub:{fontSize:12.5,fontWeight:'900',color:'#F7F8FA',marginTop:3},questReason:{fontSize:10,lineHeight:16,color:'rgba(247,248,250,.62)',marginTop:9,maxWidth:650},signalRow:{flexDirection:'row',gap:6,flexWrap:'wrap',marginTop:10},signal:{borderWidth:1,borderRadius:999,paddingHorizontal:8,paddingVertical:5,backgroundColor:'rgba(255,255,255,.02)'},signalText:{fontSize:6.5,fontWeight:'800',color:'rgba(247,248,250,.62)'},questAction:{width:'100%',gap:8},durationCrest:{alignSelf:'flex-end',width:68,height:68,borderWidth:1,borderRadius:34,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(1,5,9,.44)'},durationValue:{fontSize:17,fontWeight:'900',color:'#FFF9EE'},durationLabel:{fontSize:5.5,fontWeight:'900',letterSpacing:.7,color:'rgba(247,248,250,.48)'},primary:{minHeight:56,borderRadius:14,alignItems:'center',justifyContent:'center'},primaryText:{fontSize:10,fontWeight:'900',letterSpacing:1,color:'#F7F8FA'},secondary:{minHeight:32,alignItems:'center',justifyContent:'center'},secondaryText:{fontSize:6.5,fontWeight:'900',letterSpacing:.9},
  arcBand:{borderWidth:1,borderRadius:22,padding:16},arcTop:{flexDirection:'row',justifyContent:'space-between',gap:12,alignItems:'flex-start'},arcTitle:{fontFamily:serif,fontSize:25,fontWeight:'700',color:'#FFF9EE',marginTop:4},arcMeta:{fontSize:8,fontWeight:'800',color:'rgba(247,248,250,.50)',marginTop:4},arcScore:{alignItems:'flex-end'},arcScoreValue:{fontSize:26,fontWeight:'900',color:'#FFF9EE'},micro:{fontSize:6.2,fontWeight:'900',letterSpacing:.8,color:'rgba(247,248,250,.46)'},track:{height:6,borderRadius:99,overflow:'hidden',backgroundColor:'rgba(255,255,255,.08)',marginTop:12},fill:{height:'100%',borderRadius:99},campaignRow:{flexDirection:'row',gap:8,flexWrap:'wrap',marginTop:13},campaignNode:{flex:1,minWidth:102,borderWidth:1,borderRadius:14,padding:11,position:'relative'},campaignDay:{fontSize:6.3,fontWeight:'900',letterSpacing:.9},campaignTitle:{fontSize:10.5,fontWeight:'900',color:'#F7F8FA',marginTop:4,paddingRight:26},nextMarker:{position:'absolute',right:9,top:9,fontSize:5.5,fontWeight:'900',letterSpacing:.7},
  proofBand:{borderTopWidth:1,borderBottomWidth:1,flexDirection:'row',flexWrap:'wrap'},proof:{flex:1,minWidth:130,paddingVertical:14,paddingHorizontal:10},proofLabel:{fontSize:6.2,fontWeight:'900',letterSpacing:.8,color:'rgba(247,248,250,.42)'},proofValue:{fontSize:13,fontWeight:'900',color:'#F7F8FA',marginTop:4}
});
