...
const s=StyleSheet.create({
 safe:{flex:1,backgroundColor:'#02070B'},bg:{flex:1,backgroundColor:'#02070B'},scroll:{padding:18,paddingBottom:36},shell:{width:'100%',maxWidth:720,alignSelf:'center',gap:18},chrome:{height:42,flexDirection:'row',alignItems:'center',justifyContent:'space-between'},back:{fontSize:38,lineHeight:38,color:'#F3F5F7',fontWeight:'300'},brand:{fontFamily:fonts.display,color:'#F7F2E8',fontSize:18,letterSpacing:5},step:{fontSize:8,fontWeight:'900',letterSpacing:1.1},header:{gap:5,marginTop:4},title:{fontFamily:fonts.display,fontSize:34,lineHeight:39,color:'#F7F2E8',fontWeight:'700'},sub:{fontSize:13,lineHeight:20,color:'#AAB3BF',maxWidth:560},kicker:{fontSize:8,fontWeight:'900',letterSpacing:1.5},worldStack:{gap:12},worldCard:{borderWidth:1.2,borderRadius:20,overflow:'hidden',backgroundColor:'#071019'},worldImage:{width:'100%',aspectRatio:1.8,justifyContent:'flex-end'},worldImageStyle:{borderRadius:19},worldShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(2,5,10,.24)'},worldCopy:{padding:18,paddingRight:68,gap:4},worldName:{fontFamily:fonts.display,fontSize:30,color:'#FFF9EE',fontWeight:'700'},worldDesc:{fontSize:11,lineHeight:16,color:'#D2D7DE'},worldTag:{fontSize:9,fontWeight:'900',letterSpacing:1.2,marginTop:3},chevron:{position:'absolute',right:16,bottom:18,width:38,height:38,borderRadius:19,borderWidth:1.5,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(0,0,0,.38)'},chevronText:{fontVariant:['tabular-nums'],fontSize:33,lineHeight:33,fontWeight:'300'},goldButton:{minHeight:54,borderRadius:14,backgroundColor:'#E7B858',alignItems:'center',justifyContent:'center',paddingHorizontal:18},goldButtonText:{fontSize:11,fontWeight:'900',letterSpacing:.9,color:'#171106'},footerMark:{textAlign:'center',color:'#87909B',fontSize:9,letterSpacing:1.8,marginTop:4},heroCard:{borderWidth:1.2,borderRadius:22,overflow:'hidden',backgroundColor:'#071019'},heroImage:{width:'100%',aspectRatio:.72,justifyContent:'flex-end'},heroImageStyle:{borderRadius:21},heroShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(1,5,9,.14)'},heroBottom:{padding:24,gap:5,backgroundColor:'rgba(1,5,10,.34)'},heroName:{fontFamily:fonts.display,fontSize:34,color:'#FFF9EE',fontWeight:'700'},heroVow:{fontSize:12,color:'#E2E6EB'},eqGrid:{flexDirection:'row',flexWrap:'wrap',gap:10},eqCard:{width:'31%',aspectRatio:1,borderWidth:1,borderRadius:15,alignItems:'center',justifyContent:'center',padding:8,gap:7,position:'relative'},eqText:{fontSize:9,textAlign:'center',fontWeight:'800'},dot:{position:'absolute',top:7,right:7,width:6,height:6,borderRadius:3},goalList:{gap:8},goalRow:{minHeight:70,borderWidth:1,borderRadius:14,flexDirection:'row',alignItems:'center',gap:12,padding:11},goalIcon:{width:42,height:42,borderRadius:12,borderWidth:1,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(255,255,255,.035)'},goalName:{fontSize:14,fontWeight:'900',color:'#F4F5F7'},goalDesc:{fontSize:9.5,lineHeight:14,color:'#9EA8B4',marginTop:2},check:{fontSize:18,fontWeight:'900'},baseline:{gap:8,marginTop:2},baselineLabel:{fontSize:9,fontWeight:'900',letterSpacing:1.2,color:'#7F8995',marginTop:4},chips:{flexDirection:'row',gap:8},chip:{flex:1,minHeight:42,borderWidth:1,borderRadius:12,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(7,13,19,.88)',paddingHorizontal:5},chipText:{fontSize:9,fontWeight:'900',letterSpacing:.7,textAlign:'center'},welcome:{flex:1},welcomeShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(2,6,10,.18)'},welcomeInner:{flex:1,paddingHorizontal:28,paddingTop:24,paddingBottom:30,alignItems:'center'},welcomeBrand:{fontFamily:fonts.display,color:'#F7F2E8',fontSize:20,letterSpacing:6},welcomeTitle:{fontFamily:fonts.display,fontSize:42,lineHeight:45,textAlign:'center',color:'#FFF8EB',fontWeight:'700',textShadowColor:'rgba(0,0,0,.9)',textShadowRadius:12},welcomeSub:{fontSize:14,lineHeight:21,textAlign:'center',color:'#F0F2F4',marginTop:12,marginBottom:20,textShadowColor:'rgba(0,0,0,.9)',textShadowRadius:8},welcomeFoot:{fontSize:9,color:'#D3D8DD',letterSpacing:2.4,marginTop:14},ready:{flex:1},readyShade:{...StyleSheet.absoluteFillObject,backgroundColor:'rgba(2,6,10,.36)'},readyInner:{flex:1,padding:28,gap:10,justifyContent:'flex-end'},readyTitle:{fontFamily:fonts.display,fontSize:40,color:'#FFF9EE',fontWeight:'700'},readySub:{fontSize:13,lineHeight:20,color:'#D7DDE3',marginBottom:8}
});
