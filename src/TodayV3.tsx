...
export default function TodayV3(){
  ...
  return <SafeAreaView style={styles.safe}><ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.page,wide&&styles.pageWide]}><View style={styles.shell}>
    ...
    <Entrance delay={30}><ImageBackground source={{uri:tabArtFor(archetype,'today')}} resizeMode="cover" imageStyle={[styles.stageImage,wide&&styles.stageImageWide]} style={[styles.stage,{borderColor:material.edgeStrong}]}>
...
const styles=StyleSheet.create({
  ...
  brandRow:{flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:12,paddingHorizontal:2},brandLockup:{gap:7},brandLine:{fontSize:8.5,fontWeight:'900',letterSpacing:2.4,color:'rgba(231,184,88,.72)',marginLeft:1},brandRule:{height:1,backgroundColor:'rgba(231,184,88,.16)',marginTop:14,marginHorizontal:2},realmPill:{borderWidth:1,borderRadius:999,paddingHorizontal:12,paddingVertical:8},realmPillText:{fontSize:9,fontWeight:'900',letterSpacing:1.1},
